    ...
    internal class Program
    {
        ...
        public abstract class Oyun : IOyun
        {
            ...
            private void RaundOyna()
            {
                ...
                Console.WriteLine("\nSizin Kartınız:");
                KartCiz(kullaniciKart.Deger, "Green");
                Console.WriteLine("Bilgisayarın Kartı:");
                KartCiz(bilgisayarKart.Deger, "Red");
            ...
            private void SonuclariGoster()
            {
                ...
                if (kullanici.KazanilanRaund > bilgisayar.KazanilanRaund)
                {
                    ...
                    SoundPlayer player = new SoundPlayer(alkisDosyasi);
                    player.PlaySync();
                ...
                else if (bilgisayar.KazanilanRaund > kullanici.KazanilanRaund)
                {
                    ...
                    SoundPlayer player = new SoundPlayer(KaybetmeDosyasi);
                    player.PlaySync();
            ...
            private void KartCiz(int deger, string renk)
            {
                if (Enum.TryParse(renk, true, out ConsoleColor renkEnum))
                {
                    Console.ForegroundColor = renkEnum;
                }
                else
                {
